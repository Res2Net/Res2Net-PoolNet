...
from .deeplab_res2net import res2net50_locate
...
class PoolNet(nn.Module):
    def __init__(self, base_model_cfg, base, convert_layers, deep_pool_layers, score_layers):
        ...
        if self.base_model_cfg == 'res2net':
...
def build_model(base_model_cfg='res2net'):
    print("base_model_cfg",base_model_cfg)
    if base_model_cfg == 'vgg':
        return PoolNet(base_model_cfg, *extra_layer(base_model_cfg, vgg16_locate()))
    elif base_model_cfg == 'res2net':
        return PoolNet(base_model_cfg, *extra_layer(base_model_cfg, res2net50_locate()))
